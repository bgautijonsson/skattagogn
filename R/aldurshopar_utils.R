aldurshopar_dreifing_fig <- function(data, ...) {
    data |> 
        ...
        geom_col(aes(fill = skyribreyta, group = skyribreyta, col = skyribreyta), position = "fill") +
        scale_x_continuous() +
...
aldurshopar_magn_fig <- function(data, ...) {
    data |> 
        ...
        geom_col(aes(fill = skyribreyta, col = skyribreyta, group = skyribreyta), position = "stack") +
        scale_x_continuous() +
